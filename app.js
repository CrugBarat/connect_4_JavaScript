document.addEventListener('DOMContentLoaded', () => {
  ...
  (function(index){
    ...
    squares[i].onclick = function(){
      ...
      if(squares[index + 7].classList.contains('taken')) {
        ...
        //if square below is not taken - player can't take the square above
      } else alert('oops - cant go there')
    }
  })(i)
  ...
  function checkBoard() {
       ...
       //take the 4 values in each winningArray & plug them into the squares values
       for(let y = 0; y < winningArrays.length; y++) {
           ...
           //check arrays for player-one class
           ...
           //check arrays for player-two class
   ...
   //add event listener to each square that will trigger the checkBoard function on click
